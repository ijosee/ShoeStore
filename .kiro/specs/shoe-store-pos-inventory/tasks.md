...
- [ ] 1. Configuración del proyecto y estructura base
  - [-] 1.1 Inicializar proyecto Next.js con TypeScript, Tailwind CSS y Shadcn/ui
  ...
  - [~] 1.2 Configurar Supabase CLI y proyecto local
  ...
  - [~] 1.3 Configurar framework de testing (Vitest + fast-check + Playwright)
  ...
  - [~] 1.5 Configurar Zod y crear schemas de validación base
    - Instalar Zod
...
- [ ] 2. Esquema de base de datos y migraciones
  - [~] 2.1 Crear migraciones para tablas de configuración (stores, sizes, colors, categories, brands, payment_methods)
  ...
  - [~] 2.2 Crear migraciones para tablas de usuarios y autenticación
  ...
  - [~] 2.3 Crear migraciones para tablas de catálogo (products, product_images, product_variants)
  ...
  - [~] 2.4 Crear migraciones para tablas de inventario (stock_levels, stock_movements, stock_transfers, transfer_lines, stock_adjustments)
  ...
  - [~] 2.5 Crear migraciones para tablas de ventas y devoluciones
  ...
  - [~] 2.6 Crear migraciones para tablas de devoluciones
  ...
  - [~] 2.7 Crear migraciones para tablas de auditoría y alertas
  ...
  - [~] 2.8 Crear funciones PL/pgSQL para operaciones atómicas
  ...
  - [~] 2.9 Crear políticas de Row Level Security (RLS)
  ...
  - [~] 2.10 Crear triggers de auditoría
  ...
  - [~] 2.11 Crear archivo de datos semilla (seed.sql)
...
- [~] 3. Checkpoint — Verificar migraciones y esquema de base de datos
...
- [ ] 4. Autenticación y autorización
  - [~] 4.1 Implementar flujo de autenticación con Supabase Auth
  ...
  - [~] 4.3 Implementar middleware de autorización RBAC
...
- [ ] 5. Funciones utilitarias y lógica de negocio core
  - [~] 5.1 Implementar funciones de generación de SKU y validación de códigos de barras
  ...
  - [~] 5.4 Implementar cálculos de IVA, totales de venta y distribución de descuentos
  ...
  - [~] 5.7 Implementar cálculo de reembolso proporcional para devoluciones
...
- [~] 6. Checkpoint — Verificar lógica de negocio core
  - Ejecutar `npm run test:unit` y `npm run test:property` para verificar que todas las funciones utilitarias y sus tests pasan
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Layout principal y componentes compartidos
  - [~] 7.1 Crear layout del dashboard con sidebar y topbar
  ...
  - [~] 7.2 Crear componentes compartidos reutilizables
  ...
  - [~] 7.3 Implementar página de Dashboard con widgets por rol
...
- [ ] 8. Módulo de catálogo
  - [~] 8.1 Implementar API routes del catálogo
  ...
  - [~] 8.4 Implementar páginas de catálogo (lista, detalle, crear/editar producto)
  ...
  - [~] 8.5 Implementar páginas de categorías y marcas
...
- [ ] 9. Módulo de inventario
  - [~] 9.1 Implementar API routes de inventario
  ...
  - [~] 9.6 Implementar páginas de inventario
...
- [~] 10. Checkpoint — Verificar catálogo e inventario
...
- [ ] 11. Módulo POS — Punto de Venta
  - [~] 11.1 Implementar API routes del POS
  ...
  - [~] 11.5 Implementar Zustand store del carrito y hook useCart
  ...
  - [~] 11.6 Implementar interfaz del POS
  ...
  - [~] 11.7 Implementar escaneo de código de barras
  ...
  - [~] 11.8 Implementar páginas de historial de ventas
...
- [ ] 12. Módulo de devoluciones
  - [~] 12.1 Implementar API route de devoluciones
  ...
  - [~] 12.2 Implementar páginas de devoluciones
...
- [ ] 13. Subsistema de impresión
  - [~] 13.1 Implementar constructor de tickets ESC/POS
  ...
  - [~] 13.2 Implementar gestor de conexión Bluetooth
  ...
  - [~] 13.3 Implementar fallback de generación de PDF
    - Instalar `jspdf`
  ...
  - [~] 13.4 Implementar configuración de plantilla de ticket e impresoras
  ...
  - [~] 13.5 Integrar impresión con flujo de venta y devolución
...
- [~] 14. Checkpoint — Verificar POS, devoluciones e impresión
  - Ejecutar todos los tests unitarios y de propiedades
...
- [ ] 15. Módulo de exportación CSV
  - [~] 15.1 Implementar API route y Edge Function de exportación CSV
...
- [ ] 16. Módulo de auditoría
  - [~] 16.1 Implementar API route de auditoría
  ...
  - [~] 16.4 Implementar página de auditoría
...
- [ ] 17. Módulo de configuración
  - [~] 17.1 Implementar API routes de configuración
  ...
  - [~] 17.2 Implementar páginas de configuración
...
- [ ] 18. Módulo de gestión de usuarios
  - [~] 18.1 Implementar API routes de usuarios
  ...
  - [~] 18.2 Implementar página de gestión de usuarios
...
- [~] 19. Checkpoint — Verificar módulos de soporte
  - Ejecutar todos los tests unitarios y de propiedades
...
- [ ] 21. Configuración PWA
  - [~] 21.1 Configurar Progressive Web App
...
- [ ] 22. Pipeline CI/CD y configuración de despliegue
  - [~] 22.1 Configurar GitHub Actions para CI
  ...
  - [~] 22.2 Configurar despliegue en Vercel y Supabase
